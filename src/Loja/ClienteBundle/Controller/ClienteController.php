...
use Loja\ClienteBundle\Entity\Cliente;
use Loja\ClienteBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LojaClienteBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("LojaClienteBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LojaClienteBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LojaClienteBundle:Cliente:edit.html.twig")
     */
